            ...
            <div id="smooth-content">
                ...
                <div class="left-sidebar">
                    <div class="sidebar-header d-flex align-items-center justify-content-between">
                        ...
                        <span class="designation">Front-End & Back-End Developer</span>
                    </div>
                                    ...
                                    <div class="portfolio-item portfolio-full">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/portfolio1.png') }}" data-lightbox="example-1">
                                                <img src="{{ asset('assets/web/images/portfolio1.png') }}"
                                                    alt="Portfolio">
                                            </a>
                                    ...
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/portfolio2.webp') }}" data-lightbox="example-1">
                                                <img src="{{ asset('assets/web/images/portfolio2.webp') }}"
                                                    alt="Portfolio">
                                            </a>
                                    ...
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/portfolio3.webp') }}" data-lightbox="example-1">
                                                <img src="{{ asset('assets/web/images/portfolio3.webp') }}"
                                                    alt="Portfolio">
                                            </a>
                                    ...
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/portfolio4.jpg') }}" data-lightbox="example-1">
                                                <img src="{{ asset('assets/web/images/portfolio4.jpg') }}"
                                                    alt="portfolio">
                                            </a>
                                    ...
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/portfolio5.jpg') }}" data-lightbox="example-1">
                                                <img src="{{ asset('assets/web/images/portfolio5.jpg') }}"
                                                    alt="portfolio">
                                            </a>
                            ...
                            <div class="testimonial-slider-wrap scroll-animation" data-animation="fade_from_bottom">
                                <div class="owl-carousel testimonial-slider owl-theme">
                                    <div class="testimonial-item">
                                        <div class="testimonial-item-inner">
                                            <div class="author d-flex align-items-center">
                                                <img src="{{ asset('assets/web/images/testimonial-1.jpg') }}"
                                                    alt="portfolio">
                                                <div class="right">
                                                    <h3>Paublo Dybala</h3>
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testimonial-item-inner">
                                            <div class="author d-flex align-items-center">
                                                <img src="{{ asset('assets/web/images/testimonial-2.jpg') }}"
                                                    alt="portfolio">
                                                <div class="right">
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testimonial-item-inner">
                                            <div class="author d-flex align-items-center">
                                                <img src="{{ asset('assets/web/images/testimonial-3.jpg') }}"
                                                    alt="portfolio">
                                                <div class="right">
                                                    <h3>Phil Foden</h3>
